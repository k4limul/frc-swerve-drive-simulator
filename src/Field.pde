public class Field {
    ...
    private void setup(){
        ControlScheme p1controls = new ControlScheme('w', 's', 'a', 'd', 'e', 'q', 'f', 'c');
        ControlScheme p2controls = new ControlScheme('i', 'k', 'j', 'l', 'o', 'u', 'h', 'n');
        ...
        zones.add(new Zone("stage", new PVector(230,301), 20, 20, 3, "Blue"));
        ...
        zones.add(new Zone("stage", new PVector(570,301), 20, 20, 3, "Red"));
    ...
    private void drawInstructions() {
        ...
        text("Player 1 (Blue): WASD to move, E/Q to rotate, F to shoot, C to climb \n", width/2, height/2 - 50);
        text("Player 2 (Red): IJKL to move, O/U to rotate, H to shoot, N to climb \n", width/2, height/2 - 25);
